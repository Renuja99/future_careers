...
const Index = (props) => {
    ...
    //React hook
    const [firstName, setFirstName] = useState(props.data.userData.firstName);
    const [lastName, setLastName] = useState(props.data.userData.lastName);
    const [email, setEmail] = useState(props.data.userData.email);
    const [password, setPassword] = useState(props.data.userData.password);
    const [streetAddress, setStreetAddress] = useState(props.data.compData.street);
    const [city , setCity] = useState(props.data.compData.city);
    const [province, setProvince] = useState(props.data.compData.state);
    const [country , setCountry] = useState(props.data.compData.country);
    const [zipCode, setZipCode] = useState(props.data.compData.zipCode);
    const [description, setDescription] = useState(props.data.compData.description);
    const [companyName, setCompanyName] = useState(props.data.compData.companyName);
    const [noOfEmployees, setNoOfEmployees] = useState(props.data.compData.noOfEmp);
    const [companyRole, setCompanyRole] = useState(props.data.compData.companyName);

    const router = useRouter()

    const handleSubmit = (event) => {
        event.preventDefault();
        const reqBody = { companyId : props.data.compData._id, firstName: firstName, lastName:lastName, email: email, password:password, userType:'company', street: streetAddress, city: city,  state: province, country:country, zipCode: zipCode, description: description, companyName:companyName, noOfEmp:noOfEmployees, role_in_hiring_process: companyRole };
        ...
        .then(()=>{router.push('/organization/company_dashboard')})
                    ...
                    <div className="mx-auto">
                        <div className="xl:w-9/12 w-11/12 mx-auto xl:mx-0">
                            ...
                            <div className="mt-16  flex flex-col xl:w-full lg:w-1/2 md:w-1/2 w-full">
                                ...
                                <textarea id="about" name="about" required className="bg-transparent border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 resize-none placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder="Let the employer know who you are" rows={5} defaultValue={""} onChange={(e)=>setDescription(e.target.value)} value={description}/>
                        ...
                        <div className="container mx-auto">
                            <div className="xl:w-full lg:w-full  md:w-full flex flex-col mb-6">
                                <div className="flex flex-col lg:flex-row justify-start lg:gap-48 ">
                                    <div className="flex flex-col w-full md:w-96 mb-3">
                                        ...
                                        <input type="text" id="FirstName" name="firstName" required className="border w-full border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" onChange={(e)=>{setFirstName(e.target.value)}} value={firstName}/>
                                    </div>
                                    <div className="flex flex-col w-full md:w-96">
                                    <label htmlFor="CompanyName" className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">
                                        Organization Name
                                    </label>
                                    <input type="text" id="CompanyName" name="companyName" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" onChange={(e)=>setCompanyName(e.target.value)} value={companyName}/>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col lg:flex-row lg:gap-48">
                                    <div className="xl:w-96 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                        ...
                                        <input type="text" id="LastName" name="lastName" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" onChange={(e)=>setLastName(e.target.value)} value={lastName}/>
                                    </div>
                                    <div className="xl:w-96 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                        <label htmlFor="NumberOfEmployees" className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">
                                            Number of employees
                                        </label>
                                        <input type="text" id="NumberOfEmployees" name="noOfEmp" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" onChange={(e)=>setNoOfEmployees(e.target.value)} value={noOfEmployees}/>
                                    </div>
                            </div>
                            <div className="flex flex-col lg:flex-row lg:gap-48">
                                    <div className="xl:w-96 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                        ...
                                        <div className="border border-green-400 shadow-sm rounded flex">
                                            ...
                                            <input type="text" id="Email" name="email" required className="pl-3 py-3 w-full text-sm focus:outline-none placeholder-gray-500 rounded bg-transparent text-gray-500 dark:text-gray-400" placeholder="example@gmail.com" onChange={(e)=>setEmail(e.target.value)} value={email} />
                                        </div>
                                    ...
                                    <div className="xl:w-96 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                                ...
                                                <input type="text" id="NumberOfEmployees" name="noOfEmp" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" onChange={(e)=>setCompanyRole(e.target.value)} value={companyRole}/>
                                    </div>
                            </div>
                            <div className="xl:w-96 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                        <label htmlFor="LastName" className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">
                            ...
                            <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                ...
                                <div className="border border-gray-300 dark:border-gray-700 shadow-sm rounded flex">
                                    <input type="text" id="City" name="city" required className="pl-3 py-3 w-full text-sm focus:outline-none border border-transparent focus:border-indigo-700 bg-transparent rounded placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder="Los Angeles" onChange={(e)=>setCity(e.target.value)} value={city} />
                            ...
                            <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                ...
                                <input type="text" id="State/Province" name="state" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder="California" onChange={(e)=>setProvince(e.target.value)} value={province}/>
                            </div>
                            <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                <label htmlFor="Country" className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">
                                    Country
                                </label>
                                <input type="text" id="Country" name="country" required className="border bg-transparent border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder="United States" onChange={(e)=>setCountry(e.target.value)} value={country}/>
                            </div>
                            <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                ...
                                <input type="text" name="zip" required id="ZIP" className="bg-transparent border border-red-400 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder={86745} onChange={(e)=>setZipCode(e.target.value)} value={zipCode}/>
...
export async function getServerSideProps(context){
    ...
    const res = await fetch(`http://localhost:3000/api/organization/${params.id}`)
