  ...
  return (
    <Popover className="relative bg-white">
      <div className="max-w-8xl  mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-grey-100 py-4 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex items-start space-x-10 ">
          <a href="#" className="text-gray-500  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-base font-medium">
              Seek
            </a>
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            <a
              href="#"
              className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-400 hover:bg-indigo-700"
            >
              Sign up
            </a>
            </Link>
                ...
                <nav className="grid gap-y-8 ">
                  {solutions.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-m-3 p-3  bgflex items-center rounded-md hover:bg-gray-50"
                    >
                      <item.icon className="flex-shrink-0 h-6 w-6 text-indigo-600" aria-hidden="true" />
